            ...
            <div className="container my-5">
                <div className="row">
                    <div className="col-md-6">
                        <img src={require('../images/logo.png')} className="img-fluid" alt=""></img>
                    </div>
                    <div className="col-md-6">
                        <h2 className="mb-3">Welcome to Police Complaint and Crime Evidence Management System</h2>
                        ...
                        <a as={Link} to="/user/registration" className="btn btn-primary my-3">Register Your Complaints Today</a>
                    </div>
                </div>
            </div>
        </>
